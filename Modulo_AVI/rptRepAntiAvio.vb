...
Public Class rptRepAntiAvio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptRepAntiAvio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepAntiAvio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepAntiAvio = New rptRepAntiAvio()
        rpt.Site = Me.Site
        Return rpt
    End Function
