...
Public Class FrmSolicitudesCC
    ...
    Private Sub BttSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BttSave.Click
        ...
        If Valida() = True Then
            ...
            If Nuevo = True Then
                ta.Insert(Txtid.Text, DTfecha.Value.ToString("yyyyMMdd"), CmbClientes.SelectedValue, 0,
                TxtTIIE.Text, TxtPerBuro.Text, TxtPerBuroPM.Text, 0, TxtDif.Text, TxtSegVida.Text, "S", CmbTipoSol.Text, CAT,
                CmbFondeo.Text, TxtAnexo.Text, "01", Usuario, "N", CmbGarantia.Text, Importe, "NO", "19000101", TiptaX,
                CmbAdescuento.Text, CmbDiasVenc.Text, CmbInteMensual.Text, CmbComiApert.Text, CmbComiDisp.Text, CmbFega.Text)
            Else
        ...
        If CmbFondeo.Text = "Fira" Then
            ...
            Else
                ...
                Else
                    FegaFlat = False
                End If
                If Me.ClientesBindingSource.Current("Sucursal") = "03" Or Me.ClientesBindingSource.Current("Sucursal") = "04" Or Me.ClientesBindingSource.Current("Sucursal") = "08" Or Me.ClientesBindingSource.Current("Sucursal") = "09" Then
