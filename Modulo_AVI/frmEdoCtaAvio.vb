...
Public Class frmEdoCtaAvio
    ...
    Private Sub EdoCtaUno()
        ...
        ' ''    drDetalle("Anexo") = cAnexo
        ' ''    drDetalle("Cliente") = cCliente
        ' ''    drDetalle("Consecutivo") = nConsecutivo + 1
        ' ''    drDetalle("FechaInicial") = cFecha
        ' ''    drDetalle("FechaFinal") = cFecha
        ' ''    drDetalle("Dias") = 0
        ' ''    drDetalle("TasaBP") = 0
        ' ''    drDetalle("SaldoInicial") = nSaldoFinal
        ' ''    drDetalle("Importe") = (nSaldoFinal / 1000 * (nSegVida))
        ' ''    nSaldoFinal = nSaldoFinal + (nSaldoFinal / 1000 * (nSegVida))
        ' ''    drDetalle("SaldoFinal") = nSaldoFinal
        ' ''    drDetalle("Concepto") = "SEGURO DE VIDA"
        ' ''    drDetalle("FEGA") = 0
        ' ''    drDetalle("Garantia") = 0
        ' ''    drDetalle("Intereses") = 0
        ' ''    dsAgil.Tables("Detalle").Rows.Add(drDetalle)
