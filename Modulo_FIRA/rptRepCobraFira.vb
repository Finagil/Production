...
Public Class rptRepCobraFira
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptRepCobraFira.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepCobraFira
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepCobraFira = New rptRepCobraFira()
        rpt.Site = Me.Site
        Return rpt
    End Function
