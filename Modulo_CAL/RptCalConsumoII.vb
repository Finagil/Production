...
Public Class RptCalConsumoII
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.RptCalConsumoII.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCalConsumoII
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCalConsumoII = New RptCalConsumoII()
        rpt.Site = Me.Site
        Return rpt
    End Function
