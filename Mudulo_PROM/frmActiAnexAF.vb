...
#End Region
            ...
            Else
                With oWordDoc.Sections(1)
                    ...
                    If Round(nMtoFin / nUdi, 2) < nVMUdi Then
                        .Headers(Word.WdHeaderFooterIndex.wdHeaderFooterPrimary).Range.InsertAfter(Chr(13) & "No. RECA 1907-426-028628/01-06684-1217")
                    End If
        ...
        If cTipar = "F" Then
            ...
            Else
                With oWordDoc.Sections(1)
                    .Headers(Word.WdHeaderFooterIndex.wdHeaderFooterPrimary).Range.InlineShapes.AddPicture(LOGO_PATH)
                    If Round(nMtoFin / nUdi, 2) < nVMUdi Then
                        .Headers(Word.WdHeaderFooterIndex.wdHeaderFooterPrimary).Range.InsertAfter("No. RECA 1907-426-028628/01-06684-1217")
                    End If
    ...
    Private Sub btnContrato_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnContrato.Click
        ...
        If cFondeo = "03" Then
            cCobertura = "COBERTURA FEGA: 1.5% SOBRE SALDOS INSOLUTOS CONFORME A LA FECHA DE VENCIMIENTO EN TERMINOS DE LO ESTIPULAEDO EN LA CLAUSULA TRIGESIMA CUARTA Y TRIGESIMA SEXTA."
        ...
        If cTipar = "F" Then
            If cFondeo = "03" Then
                With oWordDoc.Sections(1)
                    ...
                    cReca = "0073-426-015054/01-00021-0114"
    ...
    Private Sub TraeDatos()
        ...
        If cFlcan <> "S" Then
            ...
            For Each drTabla In dsAgil.Tables("Tabla").Rows
                If i = 1 Then
                    ...
                    Else
                        cRenta = FormatNumber(drTabla("Abcap") + drTabla("Inter")).ToString
                    End If
                    If nRtas = 0 And nImpRD > 0 And 0 = 2 Then ' se desactiva por instrucciones de ELISANDER ()
            ...
            Else
                cParrafoInteres = "Los intereses pactados se calculan de acuerdo a lo establecido en las clausulas decima tercera y decima cuarta."
            End If
        ...
        If cTipar = "F" Then
            ...
            Else
                With oWordDoc.Sections(1)
                    ...
                    .Headers(Word.WdHeaderFooterIndex.wdHeaderFooterPrimary).Range.InsertAfter(Chr(13) & "CONTRATO DE ARRENDAMIENTO FINANCIERO No. " & Trim(Mid(cAnexo, 1, 5) & "/ " & Mid(cAnexo, 7, 4)))
                End With
                cReca = "1907-426-028628/01-06684-1217"
            End If
        End If
