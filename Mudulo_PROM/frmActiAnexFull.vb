...
Public Class frmActiAnexFull
    ...
    Private Sub btnFPC_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFPC.Click
        ...
        If cTipo = "M" Then
            cNota2 = "a) Es una sociedad debidamente constituida de acuerdo con las leyes de la República Mexicana, según consta en la escritura pública número " & Trim(drAnexoCTO("NoEscritura")) & ", otorgada ante la fe del licenciado " & Trim(drAnexoCTO("FeLicenciado")) & ", Notario público número " & Trim(drAnexoCTO("NumeroNotario")) & Trim(drAnexoCTO("NotarioDe")) & " e inscrita en el Registro Público del Comercio de " & Trim(drAnexoCTO("RegistoPublicoNo")) & " bajo el folio mercantil número " & Trim(drAnexoCTO("FolioMercantil")) & "."
            cNota2 = cNota2 & Chr(10) & Chr(10) & "b) Su(s) representante(s) legal actúa(n) con todas la facultades necesarias para obligarla, así como para suscribir el presente instrumento, facultades que a la fecha no le(s) han sido modificadas o limitadas según consta en la escritura pública número " & cNumEscRepAvacte & ", otrogada ante la fe del Lic. " & cFeLicRepAvacte & ", Notario Público " & cNumNotRepAvacte & " de " & cNotDeRepAvacte & " e inscrita en el Registro Público de Comercio del Distrito Federal bajo el folio mercantil " & cFolioMerRepAvacte
