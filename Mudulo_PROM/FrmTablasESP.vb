Public Class FrmTablasESP
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If (UsuarioGlobal.ToUpper = "DESARROLLO" Or UsuarioGlobal.ToUpper = "VELY") And DataGridView2.Rows.Count <= 0 Then
            If MessageBox.Show("¿Desea solo guardar datos del contrato?", "Guardar", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                Dim Cobertura, Fondeo As String
                ...
                Me.AnexosTablaESPTableAdapter.CambiaDatosAnexoSinTabla(TxtTasa.Text, TxtDif.Text,
                             ...
                             Fondeo, Cobertura, Liquidez, TxtOpcion.Text, DTPContrato.Value.ToString("yyyyMMdd"), TxtDere.Text, TxtPorcComi.Text, TxtComi.Text, CmbAnexos.SelectedValue)
                Exit Sub
            End If
    ...
    Sub InsertaAnexo(ByVal Plazo As Integer, ByVal FechaIni As Date)
        If MessageBox.Show("¿esta seguro de cargar la Tabla solicitada?", "Tabla Especial", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            ...
            Next
            'terminado***********************
            Dim Fondeo, Cobertura As String
            ...
            End If
            TxtComi.Text = (CDec(TxtMF.Text) * (CDec(TxtPorcComi.Text) / 100) * 1.16).ToString("n2")
            Me.AnexosTablaESPTableAdapter.CambiaDatosAnexo(TxtTasa.Text, TxtDif.Text, Plazo, _
             CmbAcumInte.Text, TxtDG.Text, TxtIvadg.Text, TxtRD.Text, RD, RDIva, TxtTasPen.Text, _
             Fondeo, Cobertura, FechaIni.ToString("yyyyMMdd"), Liquidez, TxtOpcion.Text, Mensu, _
             DTPContrato.Value.ToString("yyyyMMdd"), TxtDere.Text, TxtPorcComi.Text, TxtComi.Text, CmbAnexos.SelectedValue)
