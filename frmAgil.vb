...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.mnuCred.Index = 1
        Me.mnuCred.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.mnuSeguiCre, Me.mnuDocumentos, Me.MnuLinCred, Me.MenuItem27, Me.MenuItem31, Me.MenuItem40, Me.MenuItem50, Me.MenuItem59})
        ...
        Me.mnuSeguros.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.mnuCaptSegu, Me.mnuFormMens, Me.MnuAltaPolAvi, Me.MnuSegFin, Me.MnuFactorPol, Me.MenuItem20, Me.MenuItem57, Me.MenuItem58, Me.MenuItem77})
        ...
        Me.MenuItem32.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem94, Me.MenuItem95})
        Me.MenuItem32.Text = "Cambio de Fecha de Contrato"
        '
        'MenuItem94
        '
        Me.MenuItem94.Index = 0
        Me.MenuItem94.Text = "Tradicionales"
        '
        'MenuItem95
        '
        Me.MenuItem95.Index = 1
        Me.MenuItem95.Text = "Avios"
        '
        'MenuItem30
        '
        ...
        Me.MenuItem63.Text = "Solicitar Adelanto (Saldo a Favor)"
        '
        'MenuItem65
        '
...
#End Region
    ...
    Private Sub MnuGastosEXT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub MenuItem61_Click(sender As Object, e As EventArgs) Handles MenuItem61.Click
        Dim f As New FrmAplicaSaldoFavor
        f.Show()
    End Sub
    ...
    Private Sub MenuItem68_Click(sender As Object, e As EventArgs) Handles MenuItem68.Click
        If TaQUERY.SacaPermisoModulo("DATOS_EMPRESA", UsuarioGlobal) > 0 Then
            Dim newfrmPideContrato As New frmPideContrato("DATOS_EMPRESA")
            newfrmPideContrato.Show()
        Else
    ...
    Private Sub MenuItem94_Click(sender As Object, e As EventArgs) Handles MenuItem94.Click
