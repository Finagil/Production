Public Class FrmSeguroAvio
    ...
    Private Sub BtnMinistrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnMinistrar.Click
        ...
        If TxtFondeo.Text = "03" Then
            ...
            Fega = CalculaFEGA(Xministrar, AviosBindingSource.Current("FegaFlat"), AviosBindingSource.Current("FechaTerminacion"), AviosBindingSource.Current("AplicaFecga"), AviosBindingSource.Current("PorcFega"), CmbClientes.SelectedValue, Me.ClientesBindingSource.Current("Sucursal"), "AV")
        End If
        Dim ta As New SegurosDSTableAdapters.mFINAGILTableAdapter
