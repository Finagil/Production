...
Public Class rptTablaFullCosto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptTablaFullCosto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTablaFullCosto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTablaFullCosto = New rptTablaFullCosto()
        rpt.Site = Me.Site
        Return rpt
    End Function
