...
Public Class rptTablaEquipodep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptTablaEquipodep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTablaEquipodep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTablaEquipodep = New rptTablaEquipodep()
        rpt.Site = Me.Site
        Return rpt
    End Function
