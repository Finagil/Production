...
Public Class rptTablaSeguro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptTablaSeguro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTablaSeguro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTablaSeguro = New rptTablaSeguro()
        rpt.Site = Me.Site
        Return rpt
    End Function
