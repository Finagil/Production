...
Public Class rptTablaRefacc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptTablaRefacc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTablaRefacc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTablaRefacc = New rptTablaRefacc()
        rpt.Site = Me.Site
        Return rpt
    End Function
