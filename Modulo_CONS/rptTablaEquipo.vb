...
Public Class rptTablaEquipo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptTablaEquipo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTablaEquipo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTablaEquipo = New rptTablaEquipo()
        rpt.Site = Me.Site
        Return rpt
    End Function
