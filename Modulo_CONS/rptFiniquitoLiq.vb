...
Public Class rptFiniquitoLiq
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptFiniquitoLiq.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFiniquitoLiq
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFiniquitoLiq = New rptFiniquitoLiq()
        rpt.Site = Me.Site
        Return rpt
    End Function
