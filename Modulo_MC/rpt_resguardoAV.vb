...
Public Class rpt_resguardoAV
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rpt_resguardoAV.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Firma_Recibe() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Firma_Entrega() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_resguardoAV
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_resguardoAV = New rpt_resguardoAV()
        rpt.Site = Me.Site
        Return rpt
    End Function
