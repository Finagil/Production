...
Public Class frm_Solicitud_Transferencia
    ...
    Sub GeneraSolicitud()
        ...
        If Me.Solicitud_transDS.vw_MC_SOLICITUD_TRANSFERENCIA.Rows.Count > 0 Then
            ...
            End If
            Try
                Dim Archivo As String = My.Settings.RutaTMP & "\AV\Tranfer_" & frm_Solicitud_Transferencia.id_anexo & "-" & frm_Solicitud_Transferencia.Ciclo & "-" & Now.TimeOfDay.ToString("hhmmss") & ".Pdf"
                Dim ArchivoTmp As String = Path.GetTempPath() & "\Tranfer_" & frm_Solicitud_Transferencia.id_anexo & "-" & frm_Solicitud_Transferencia.Ciclo & "-" & Now.TimeOfDay.ToString("hhmmss") & ".Pdf"
                File.Delete(Archivo)
