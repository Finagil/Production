...
Public Class rpt_resguardos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rpt_resguardos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_resguardos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_resguardos = New rpt_resguardos()
        rpt.Site = Me.Site
        Return rpt
    End Function
