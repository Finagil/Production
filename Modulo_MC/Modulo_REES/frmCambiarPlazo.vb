...
Public Class frmCambiarPlazo
    ...
    Dim taO As New ReestructDSTableAdapters.EdoctaoTableAdapter
    ...
    Private Sub frmCapitalizacion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If nSaldoEquipo = 0 Then
                ...
                MessageBox.Show("Contrato SIN saldo insoluto", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Me.Close()
            ...
            Else
                ...
                If nVencimiento = 0 Then
                    MessageBox.Show("Existe algún ERROR en el contrato", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End If
            End If
        End If
    ...
    Private Sub btnIniciar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnIniciar.Click
        ...
        Dim dtCreaTablaX As New DataTable("Principal")
        ...
        nIvaCapital = tav.SumIvaCapital(Anexo)

        If Val(txtPlazo.Text) <= Val(txtPzo.Text) Then
            MessageBox.Show("El plazo mínimo es de " & Val(txtPzo.Text) + 1, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        ...
        If Val(TxtSaldoInsoluto.Text) > 0 And txtPlazo.Text > nPlazo Then
            ...
            dtCreaTablaX.Columns.Add("Letra", Type.GetType("System.String"))
            dtCreaTablaX.Columns.Add("Feven", Type.GetType("System.String"))
            dtCreaTablaX.Columns.Add("Nufac", Type.GetType("System.Decimal"))
            dtCreaTablaX.Columns.Add("Saldo", Type.GetType("System.String"))
            dtCreaTablaX.Columns.Add("Capital", Type.GetType("System.String"))
            dtCreaTablaX.Columns.Add("Interes", Type.GetType("System.String"))
            dtCreaTablaX.Columns.Add("Iva", Type.GetType("System.String"))
            dtCreaTablaX.Columns.Add("IvaCapital", Type.GetType("System.String"))
            ...
            For i = 1 To txtPlazo.Text
                ...
                If nIvaCapital > 0 Then
                    drDato("IvaCapital") = nCapital * nValorIva
                Else
                    drDato("IvaCapital") = 0
                End If
                dtCreaTablaX.Rows.Add(drDato)
            ...
            DataGrid2.DataSource = dtCreaTablaX
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        'Try
        taO.BorraAdeudoPrincipal(Anexo)
