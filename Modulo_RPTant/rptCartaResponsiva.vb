...
Public Class rptCartaResponsiva
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptCartaResponsiva.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCartaResponsiva
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCartaResponsiva = New rptCartaResponsiva()
        rpt.Site = Me.Site
        Return rpt
    End Function
