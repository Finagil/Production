...
Public Class rptRepAvisosxVen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptRepAvisosxVen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepAvisosxVen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepAvisosxVen = New rptRepAvisosxVen()
        rpt.Site = Me.Site
        Return rpt
    End Function
