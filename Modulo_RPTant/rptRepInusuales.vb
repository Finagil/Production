...
Public Class rptRepInusuales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptRepInusuales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepInusuales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepInusuales = New rptRepInusuales()
        rpt.Site = Me.Site
        Return rpt
    End Function
