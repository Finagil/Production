...
Public Class rptHistoriaRESP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptHistoriaRESP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHistoriaRESP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHistoriaRESP = New rptHistoriaRESP()
        rpt.Site = Me.Site
        Return rpt
    End Function
