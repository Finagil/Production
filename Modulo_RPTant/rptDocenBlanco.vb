...
Public Class rptDocenBlanco
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptDocenBlanco.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDocenBlanco
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDocenBlanco = New rptDocenBlanco()
        rpt.Site = Me.Site
        Return rpt
    End Function
