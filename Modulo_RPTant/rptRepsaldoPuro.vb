...
Public Class rptRepsaldoPuro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptRepsaldoPuro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepsaldoPuro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepsaldoPuro = New rptRepsaldoPuro()
        rpt.Site = Me.Site
        Return rpt
    End Function
