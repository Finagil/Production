...
Public Class RptHistoriaResumen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.RptHistoriaResumen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptHistoriaResumen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptHistoriaResumen = New RptHistoriaResumen()
        rpt.Site = Me.Site
        Return rpt
    End Function
