...
Public Class rptNotadeCredito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptNotadeCredito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNotadeCredito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNotadeCredito = New rptNotadeCredito()
        rpt.Site = Me.Site
        Return rpt
    End Function
