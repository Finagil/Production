...
Public Class rptTablaCotizador
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptTablaCotizador.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTablaCotizador
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTablaCotizador = New rptTablaCotizador()
        rpt.Site = Me.Site
        Return rpt
    End Function
