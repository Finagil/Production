...
Public Class rptReestructura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptReestructura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReestructura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReestructura = New rptReestructura()
        rpt.Site = Me.Site
        Return rpt
    End Function
