...
Public Class rptFiniquitoAP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptFiniquitoAP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFiniquitoAP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFiniquitoAP = New rptFiniquitoAP()
        rpt.Site = Me.Site
        Return rpt
    End Function
