...
Public Class rptRelevantesC1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptRelevantesC1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRelevantesC1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRelevantesC1 = New rptRelevantesC1()
        rpt.Site = Me.Site
        Return rpt
    End Function
