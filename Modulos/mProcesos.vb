...
Module mProcesos
    ...
    Public Function Letras(ByVal numero As String, Optional Moneda As String = "MXN") As String
        ...
        If Len(dec) > 2 Then dec = Mid(dec, 1, 2)
    ...
    Public Function Letras2(ByVal numero As String, Optional Moneda As String = "MXN") As String
        ...
        cCant_Cent = Cambio2(cCentenas)
        cCant_Mil = Cambio2(cMiles)
        cCant_Mill = Cambio2(cMillones)
    ...
    Public Function Cambio2(ByVal Cantidad As String) As String
    ...
    Public Function Cant_LetrasSinParentesis(ByVal Numero As String, ByRef cCadena As String) As String
        ...
        cTemp_Ent = Letras2(Numero)
        nAncho = Len(cTemp_Ent)
        cCadena = Mid(cTemp_Ent, 2, nAncho - 19)

        If Trim(Dec) = "" Then
            Cant_LetrasSinParentesis = cCadena
        Else
            cTemp_Dec = Letras2(Dec)
            y = Len(cTemp_Dec)
            If Dec = "00" Then
                cCadena = cCadena & " PUNTO CERO"
            Else
    ...
    Public Function TerminaANT(dInicio As Date, nplazoX As Decimal) As Date
        ...
        ElseIf nMonth = 0 Then
            ...
            nYear -= 1
        End If
        TerminaANT = DateSerial(nYear, nMonth, nDay)

        If nDay <> 6 And nDay <> 16 And nDay <> 20 And nDay <> 25 Then
            TerminaANT = IIf(Month(TerminaANT) > nMonth, DateAdd(DateInterval.Month, -1, TerminaANT), TerminaANT)
            TerminaANT = DayWeek(TerminaANT)
        End If
    ...
    Public Function Adanterior(ByRef dtAdeudos As DataTable, ByVal drUdis As DataRowCollection, ByVal drFacturas As DataRowCollection, ByVal cFecha As String) As Decimal
        ...
        For Each drFactura In drFacturas
            ...
            Else
                nAdeudoAnterior = IIf(nSaldoFac > 0, nSaldoFac, 0)
            End If
