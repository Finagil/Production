...
Public Class RptDatosAnexoFull
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.RptDatosAnexoFull.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDatosAnexoFull
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDatosAnexoFull = New RptDatosAnexoFull()
        rpt.Site = Me.Site
        Return rpt
    End Function
