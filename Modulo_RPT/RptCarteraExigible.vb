...
Public Class RptCarteraExigible
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.RptCarteraExigible.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCarteraExigible
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCarteraExigible = New RptCarteraExigible()
        rpt.Site = Me.Site
        Return rpt
    End Function
