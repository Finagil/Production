...
Public Class RptColocacionAvio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.RptColocacionAvio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptColocacionAvio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptColocacionAvio = New RptColocacionAvio()
        rpt.Site = Me.Site
        Return rpt
    End Function
