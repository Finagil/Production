...
Public Class rptSegurosCierre
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptSegurosCierre.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSegurosCierre
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSegurosCierre = New rptSegurosCierre()
        rpt.Site = Me.Site
        Return rpt
    End Function
