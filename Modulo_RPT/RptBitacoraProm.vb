...
Public Class RptBitacoraProm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.RptBitacoraProm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBitacoraProm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBitacoraProm = New RptBitacoraProm()
        rpt.Site = Me.Site
        Return rpt
    End Function
