...
Public Class RptSaldosPromedio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.RptSaldosPromedio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSaldosPromedio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSaldosPromedio = New RptSaldosPromedio()
        rpt.Site = Me.Site
        Return rpt
    End Function
