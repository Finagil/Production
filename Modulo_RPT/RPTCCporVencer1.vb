...
Public Class RPTCCporVencer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.RPTCCporVencer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTCCporVencer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTCCporVencer = New RPTCCporVencer()
        rpt.Site = Me.Site
        Return rpt
    End Function
