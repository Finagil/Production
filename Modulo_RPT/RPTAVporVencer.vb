...
Public Class RPTAVporVencer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.RPTAVporVencer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTAVporVencer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTAVporVencer = New RPTAVporVencer()
        rpt.Site = Me.Site
        Return rpt
    End Function
