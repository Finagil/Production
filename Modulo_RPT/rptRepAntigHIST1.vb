...
Public Class rptRepAntigHIST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptRepAntigHIST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepAntigHIST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepAntigHIST = New rptRepAntigHIST()
        rpt.Site = Me.Site
        Return rpt
    End Function
