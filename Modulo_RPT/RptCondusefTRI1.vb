...
Public Class RptCondusefTRI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.RptCondusefTRI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCondusefTRI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCondusefTRI = New RptCondusefTRI()
        rpt.Site = Me.Site
        Return rpt
    End Function
