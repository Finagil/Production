...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New(ByVal cAnexo As String)
        ...
        Me.Text = "Calculo de Finiquito Arrendamiento Puro"
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label15.Text = "Valor Residual con IVA"
        ...
        Me.Label3.Text = "IVA Diferido Valor Residual"
        '
        'txtComision
        '
        ...
        Me.Name = "frmCalcfiniAP"
        Me.Text = "Cálculo de Finiquito Arrendamiento Puro"
...
#End Region
    ...
    Private Sub btnProcesar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcesar.Click
        ...
        nIvaDiferido = nSaldoEquipo * 0.16
        ...
        'txtIvaDiferido.Text = FormatNumber(nSaldoEquipo * 0.16, 2)
        ...
        'txtIvaIntereses.Text = FormatNumber(nInteres * 0.16, 2)
    ...
    Private Sub btnImprimir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnImprimir.Click
        ...
        Dim newrptFiniquito As New rptFiniquitoAP()
