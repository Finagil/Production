...
Public Class RptImpreFacFull
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.RptImpreFacFull.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptImpreFacFull
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptImpreFacFull = New RptImpreFacFull()
        rpt.Site = Me.Site
        Return rpt
    End Function
