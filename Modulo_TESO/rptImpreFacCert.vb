...
Public Class rptImpreFacCert
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptImpreFacCert.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptImpreFacCert
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImpreFacCert = New rptImpreFacCert()
        rpt.Site = Me.Site
        Return rpt
    End Function
