...
Public Class rptConciliacionCartera
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptConciliacionCartera.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agil.rptConciliacionCartera.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(False),
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>
    Public ReadOnly Property Parameter_TipoCredito() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(False),
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>
    Public ReadOnly Property Parameter_Texto1() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptConciliacionCartera
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptConciliacionCartera = New rptConciliacionCartera()
        rpt.Site = Me.Site
        Return rpt
    End Function
