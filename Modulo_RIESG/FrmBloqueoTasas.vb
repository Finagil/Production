Public Class FrmBloqueoTasas
    ...
    Private Sub FrmBloqueoTasas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.AnexosBloqueadoTasaTableAdapter.Fill(Me.GeneralDS.AnexosBloqueadoTasa, False)
        Me.AnexosBloqueadoTasaTableAdapter.Fill(Me.GeneralDS1.AnexosBloqueadoTasa, True)
